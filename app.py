...
from config import (
    APP_NAME, APP_VERSION, APP_ICON, TEAM_NAME, HACKATHON,
    DEFAULT_CITY, PAGES
)
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; color: #9ca3af; font-size: 0.8rem;">
            ...
            <p style="margin: 5px 0 0 0;">{HACKATHON}</p>
        </div>
        """, unsafe_allow_html=True)
...
def render_mobile_navigation():
    """Render mobile navigation with hamburger menu."""
    ...
    <div class="mobile-nav" id="mobileNav">
        <div class="mobile-nav-header">
            <span style="font-weight: bold; color: #00d9ff;">📍 Navigation</span>
    ...
    for page_name, icon in footer_items:
